...
#define  MC_REG_ACIM_LSO_I_F             ((117U << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT)
...
#define  MC_REG_ACIM_LSO_K				 ((110 << ELT_IDENTIFIER_POS) | TYPE_DATA_32BIT)
#define  MC_REG_ACIM_LSO_KP				 ((111 << ELT_IDENTIFIER_POS) | TYPE_DATA_32BIT)
#define  MC_REG_ACIM_LSO_KI				 ((112 << ELT_IDENTIFIER_POS) | TYPE_DATA_32BIT)
